package com.mbs.Robots;// depends: baja; program; control; bacnet; onyxxDriver; nrio; driver; alarm; kitControl
        ...
        extends Robot
{
     ...
     *
     ************************************************************************
     ************TEMPS POINTS NEED TO HAVE CONVERSIONS SET*******************
     ************************************************************************
     *
     *
     *************************************************************/
     ...
     ************************************/
    public String[] OnyxPointsPath = {"station:|slot:/Drivers/OnyxxNetwork2/RERVU_2/points"};
    public String[] NrioPointsPath = {"station:|slot:/Drivers/OnyxxNetwork/RERVU_2/points"};
...
//                        }
                        ...
                        log.println("BAD SOURCE COMPONENT ON: " + point.getSlotPath());
